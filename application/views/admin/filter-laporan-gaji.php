...
<div class="card mx-auto" style="width: 35%;">
    <div class="card-header bg-primary text-white text-center">Filter Laporan Gaji Pegawai</div>
    ...
    <form action="<?= base_url('admin/LaporanGaji/cetakLaporanGaji') ?>" method="post">
        <div class="card-body">
            ...
            <button type="submit" class="btn btn-primary" style="width: 100%;"><i class="fas fa-print mr-2"></i>Cetak Laporan Gaji</button>
        </div>
    </form>
</div>
